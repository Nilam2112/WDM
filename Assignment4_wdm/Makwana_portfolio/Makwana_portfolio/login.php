...
{
  $sql="SELECT User, Password FROM signup where User='$user' and Password='$password'";
      ...
      else
      {
        if(mysqli_num_rows($result)>0)
        {
          $_SESSION['User']=$user;
           echo "<script>
            alert('Success !!');
window.location.href='About Me.php'
</script>"; 
        }
        else
        {
...
<body id="wrapper">
        ...
        <main>
            <form method="post" name="LoginForm" onsubmit="return ValidateLogin()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <label  for="User" style="color: #777777; font-size: 0.70em; font-family: Roboto; margin-left:13px;"> User:</label><br/>
            <input type="text" id="User"  name="User" required  style="width:456px;height:36px;color:#000033;font-size:0.70em;font-family:Roboto;margin-left:13px;">
            ...
            <input type="password" id="Password" name="Password" required    style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
