...
<body id="wrapper">
      ...
      <main>
      <form method="post" name="SignForm" onsubmit="return ValidateSign()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
     <!-- <form name="SignForm" action="" onsubmit="return ValidateSign()" method="post">-->
                <!-- <form action="/action_.php" method="get"> -->
                <div class="signup">
                <p style="font-family: Roboto; font-size: 0.70em; color: #777777; margin-left:16px; margin-top: 10px;">check in </p>
                <hr style="color: #FFFFFF;">

        <label  for="Firstname" style="color: #777777; font-size: 0.70em; font-family: Roboto; margin-left:13px;">Name:</label><br/>
            <input type="text"id="Firstname" required name="Firstname"  placeholder="Enter firstname"  title="please Enter a valid firstname" style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
            ...
            <input type="text"id="Lastname" required name="Lastname"   placeholder="Enter lastname"    title="please Enter a valid Lastname"  style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
            <span class="error">   <?php echo $lnameErr;?></span>
            <label for="Email" style="color: #777777; font-size: 0.70em; font-family: Roboto; margin-left:13px;"> Email:</label><br/>
            <input type="text"id="Email"  name="Email"  placeholder="Enter email" title="please Enter a valid Email" required style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
            ...
            <input type="text"id="User" name="User" required  placeholder="Enter username"   title="please Enter a valid Username"  style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
            <span class="error">   <?php echo $userErr;?></span>
            <label for="Password" style="color: #777777; font-size: 0.70em; font-family: Roboto; margin-left:13px;"> Password:</label><br/>
            <input type="password"id="Password" required name="Password"  placeholder="Enter Password" style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
            ...
            <input type="password"id="Repeat_Password" required name="Repeat Password"   placeholder="Enter Password" style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
