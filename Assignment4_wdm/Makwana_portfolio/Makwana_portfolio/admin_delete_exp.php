...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["c_name"])) {
    ...
    $cname = test_input($_POST["c_name"]);
    if(!preg_match("/^[A-Za-z]*$/",$cname))
      {
                $cnameErr = "Only letters allowed for company name";
    }
...
$sql = "DELETE FROM exp WHERE c_name='$_POST[c_name]'";
...
<body id="wrapper">
     ...
     <!-- <form name="SignForm" action="" onsubmit="return ValidateSign()" method="post">-->
                ...
                <p style="font-family: Roboto; font-size: 0.70em; color: #777777; margin-left:16px; margin-top: 10px;">Admin can delete a experience: </p>
            ...
            <input type="text"id="c_name" name="c_name"  placeholder="Enter company name"   title="please Enter a valid company name"  style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
