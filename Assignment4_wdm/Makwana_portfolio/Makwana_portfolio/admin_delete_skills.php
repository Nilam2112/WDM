...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["s_name"])) {
    $snameErr = "skill name is required";
  } else {
    $sname = test_input($_POST["s_name"]);
    if(!preg_match("/^[A-Za-z]*$/",$sname))
      {
                $snameErr = "Only letters allowed for skill name";
    }
...
$sql = "DELETE FROM skill WHERE skill_name='$_POST[s_name]'";
...
<body id="wrapper">
     ...
     <!-- <form name="SignForm" action="" onsubmit="return ValidateSign()" method="post">-->
                ...
                <p style="font-family: Roboto; font-size: 0.70em; color: #777777; margin-left:16px; margin-top: 10px;">Admin can delete  skills: </p>
                <hr style="color: #FFFFFF;">

            <label  for="s_name" style="color: #777777; font-size: 0.70em; font-family: Roboto; margin-left:16px;margin-top: 20px;">skill Name:</label><br/>
            <input type="text"id="s_name" name="s_name"  placeholder="Enter skill name"   title="please Enter a valid skill name"  style="width:456px;height:36px;color:#777777;font-size:0.70em;font-family:Roboto;margin-left:13px;">
